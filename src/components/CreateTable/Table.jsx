...
export default function Table() {
    ...
    const Reset = (e) => {
        ...
        setWash({...wash,[name]:{washing:false,ironing:false,drywashing:false,chamicalwash:false}})
                ...
                <table className='create__table'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{quantity.boxers>0 && <button name="boxers" id = "17" onClick={Reset} className="reset__button">Reset</button>}</td>
                        </tr>
                        <tr>
                            <td>
                                <div className='title'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button name="joggers" value="15" onClick={Total} disabled = {disable[25]} className="wash__button"><img id="26" src={color[25] ? ironingIconBlue : ironingIcon}  className='wash__image' alt="ironing" /></button>
